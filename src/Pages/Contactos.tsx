    ...
    <>
      <main className="min-h-main w-screen flex flex-col items-baseline p-7 pb-[13vh] lg:pb-0 gap-7">
        ...
        <section className="w-full flex flex-col items-baseline gap-8">
          ...
          <div className="rounded-2xl bg-black w-full h-23 flex items-center justify-between p-3">
          ...
          <div className="flex flex-col lg:flex-row gap-5 w-full">
            {contactos.map((contacto) => (
              <div className="bg-white rounded-2xl flex flex-col gap-3 w-full h-40 items-center justify-center">
                <div className="w-full h-45/100 flex items-center p-1 gap-3 pl-6">
                  <img
                    className="border rounded-full aspect-square h-95/100 text-xs"
                    src=""
          ...
          <div className="w-full bg-[#EFF4FC] rounded-xl h-40 flex justify-evenly items-center p-2 lg:w-25/100">
          ...
          <h1 className="bg-gray-200 rounded-xl w-full text-center font-semibold p-2 text-xl">Avisar a {contactos[0]} para agregar contactos.</h1>
        </section>
      </main>
    </>
  );
