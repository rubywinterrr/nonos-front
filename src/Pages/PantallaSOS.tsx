...
export default function SOS() {
  return (
    <>
      <Header />
      <main className="h-main w-screen flex flex-col lg:flex-row items-center justify-evenly bg-main2 gap-10">
        <div className="w-sm h-fit flex flex-col justify-center items-center gap-2">
